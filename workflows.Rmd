...
## Reproducible research in action {#repro-research}

- [The Practice of Reproducible Research: Case Studies and Lessons from the Data-Intensive Sciences](https://www.practicereproducibleresearch.org) - Justin Kitzes, Daniel Turek, Fatma Deniz (Editors)
  - Examples highlighting R, Python, open science, cloud computing, neuroimaging, and more
...
-   [Using SQL in RStudio](https://irene.rbind.io/post/using-sql-in-rstudio/)
    ...
    -   Assumes you are already an R/RStudio user. For a refresher...\@ref(rstats-intro)
